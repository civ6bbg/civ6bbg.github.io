            ...
            with div(cls="row",
                ...
                for item in civ_leaders_items[leader]:
                    ...
                    if item[3].startswith('UNIT_'):
                        ...
                        show_element_with_base_option(item[5], lang, locs_data, en_US_locs_data)
                    br()
    return create_page(bbg_version, lang, title, 'leaders', menu_items, menu_icons, 'images/leaders', create_leader_page)
            ...
            with div(cls="row"):
                for cs in cs_by_type[cs_type]:
                    with div(cls="col-lg-6 col-md-12"), div(cls="chart"):
                        ...
                        br()
    return create_page(bbg_version, lang, title, 'city_states', menu_items, menu_icons, 'images', create_city_state_page)
    ...
    def create_misc_page():
        ...
        for alliance in alliance_list:
            with div(cls="row", id=get_loc(locs_data, alliance[1], en_US_locs_data)), div(cls="col-lg-12"):
                ...
                br()
    return create_page(bbg_version, lang, title, 'misc', menu_items, menu_icons, 'images', create_misc_page) 
...
def get_expanded_html_file(bbg_version, lang):
    ...
    return create_page(bbg_version, lang, title, 'bbg_expanded', menu_items, menu_icons, 'images', create_expanded_page)
